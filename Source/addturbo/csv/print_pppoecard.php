...
$group_user=$db->selectquery("SELECT * FROM pppoe_gen WHERE ".$to_print."='".$_GET['id']."'");
	$pro=$db->selectquery("SELECT * FROM pppoe_pro WHERE pro_name='".$group_user['profile']."'");
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"
"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>PPPOE Vouchers</title>
...
$sql=$db->DB->prepare("SELECT * FROM pppoe_gen WHERE ".$to_print."='".$_GET['id']."'");
	        $sql->execute();
...
echo "<td style=\"width: 50%; text-align: center;\">".$pro['package_name']."</td>";
echo "</tr>";
echo "<tr>";
echo "<td style=\"width: 50%; text-align: center;\">Data Limit</td>";
echo "<td style=\"width: 50%; text-align: center;\">".$pro['data_limit']."</td>";
echo "</tr>";
echo "<tr>";
...
echo "</table>";
echo "</td>";
echo "<td style=\"background-color:#FFFFFF;\"><div align=\"center\"  \">
<img src=\"../img/logo.png\" width=\"80\" height=\"135\"></div></td>";
echo "</tr>";
echo "</tbody>";
echo "</table>";
