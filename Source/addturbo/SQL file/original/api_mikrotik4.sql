...
--
-- Host: localhost
-- Generation Time: Oct 03, 2017 at 01:42 AM
...
--
ALTER TABLE `am`
  MODIFY `am_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
--
-- AUTO_INCREMENT for table `mt_config`
--
ALTER TABLE `mt_config`
  MODIFY `mt_num` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
--
-- AUTO_INCREMENT for table `mt_edit`
--
ALTER TABLE `mt_edit`
  MODIFY `number` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
