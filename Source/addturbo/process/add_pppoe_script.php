<?php
   ...
   $scr_exno1=""; if($expirepro_no1!=0){$scr_exno1=":if (\"\$prof".($conf)."P\" = \"".$pro_no1."\") do={:set offset".($conf)."P ".$expirepro_no1."}";}
   $scr_exno2=""; if($expirepro_no2!=0){$scr_exno2=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no2."\") do={:set offset".($conf)."P ".$expirepro_no2."}";}
   $scr_exno3=""; if($expirepro_no3!=0){$scr_exno3=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no3."\") do={:set offset".($conf)."P ".$expirepro_no3."}";}
   $scr_exno4=""; if($expirepro_no4!=0){$scr_exno4=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no4."\") do={:set offset".($conf)."P ".$expirepro_no4."}";}
   $scr_exno5=""; if($expirepro_no5!=0){$scr_exno5=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no5."\") do={:set offset".($conf)."P ".$expirepro_no5."}";}
   $scr_exno6=""; if($expirepro_no6!=0){$scr_exno6=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no6."\") do={:set offset".($conf)."P ".$expirepro_no6."}";}
   $scr_exno7=""; if($expirepro_no7!=0){$scr_exno7=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no7."\") do={:set offset".($conf)."P ".$expirepro_no7."}";}
   $scr_exno8=""; if($expirepro_no8!=0){$scr_exno8=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no8."\") do={:set offset".($conf)."P ".$expirepro_no8."}";}
   $scr_exno9=""; if($expirepro_no9!=0){$scr_exno9=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no9."\") do={:set offset".($conf)."P ".$expirepro_no9."}";}
   $scr_exno10=""; if($expirepro_no10!=0){$scr_exno10=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no10."\") do={:set offset".($conf)."P ".$expirepro_no10."}";}
   ###########################ADD###############
   $scr_exno11=""; if($expirepro_no11!=0){$scr_exno11=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no11."\") do={:set offset".($conf)."P ".$expirepro_no11."}";}
   $scr_exno12=""; if($expirepro_no12!=0){$scr_exno12=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no12."\") do={:set offset".($conf)."P ".$expirepro_no12."}";}
   $scr_exno13=""; if($expirepro_no13!=0){$scr_exno13=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no13."\") do={:set offset".($conf)."P ".$expirepro_no13."}";}
   $scr_exno14=""; if($expirepro_no14!=0){$scr_exno14=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no14."\") do={:set offset".($conf)."P ".$expirepro_no14."}";}
   $scr_exno15=""; if($expirepro_no15!=0){$scr_exno15=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no15."\") do={:set offset".($conf)."P ".$expirepro_no15."}";}
   $scr_exno16=""; if($expirepro_no16!=0){$scr_exno16=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no16."\") do={:set offset".($conf)."P ".$expirepro_no16."}";}
   $scr_exno17=""; if($expirepro_no17!=0){$scr_exno17=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no17."\") do={:set offset".($conf)."P ".$expirepro_no17."}";}
   $scr_exno18=""; if($expirepro_no18!=0){$scr_exno18=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no18."\") do={:set offset".($conf)."P ".$expirepro_no18."}";}
   $scr_exno19=""; if($expirepro_no19!=0){$scr_exno19=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no19."\") do={:set offset".($conf)."P ".$expirepro_no19."}";}
   $scr_exno20=""; if($expirepro_no20!=0){$scr_exno20=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no20."\") do={:set offset".($conf)."P ".$expirepro_no20."}";}
   ###########################/.ADD############



   $scr_remno1=""; if($expirepro_no1!=0){$scr_remno1=":if (\"\$prof".($conf)."P\" = \"".$pro_no1."\") do={:set offset".($conf)."P ".($expirepro_no1+$offset_remove)."}";}
   $scr_remno2=""; if($expirepro_no2!=0){$scr_remno2=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no2."\") do={:set offset".($conf)."P ".($expirepro_no2+$offset_remove)."}";}
   $scr_remno3=""; if($expirepro_no3!=0){$scr_remno3=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no3."\") do={:set offset".($conf)."P ".($expirepro_no3+$offset_remove)."}";}
   $scr_remno4=""; if($expirepro_no4!=0){$scr_remno4=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no4."\") do={:set offset".($conf)."P ".($expirepro_no4+$offset_remove)."}";}
   $scr_remno5=""; if($expirepro_no5!=0){$scr_remno5=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no5."\") do={:set offset".($conf)."P ".($expirepro_no5+$offset_remove)."}";}
   $scr_remno6=""; if($expirepro_no6!=0){$scr_remno6=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no6."\") do={:set offset".($conf)."P ".($expirepro_no6+$offset_remove)."}";}
   $scr_remno7=""; if($expirepro_no7!=0){$scr_remno7=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no7."\") do={:set offset".($conf)."P ".($expirepro_no7+$offset_remove)."}";}
   $scr_remno8=""; if($expirepro_no8!=0){$scr_remno8=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no8."\") do={:set offset".($conf)."P ".($expirepro_no8+$offset_remove)."}";}
   $scr_remno9=""; if($expirepro_no9!=0){$scr_remno9=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no9."\") do={:set offset".($conf)."P ".($expirepro_no9+$offset_remove)."}";}
   $scr_remno10=""; if($expirepro_no10!=0){$scr_remno10=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no10."\") do={:set offset".($conf)."P ".($expirepro_no10+$offset_remove)."}";}
   ########################### ADD ############
   $scr_remno11=""; if($expirepro_no11!=0){$scr_remno11=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no11."\") do={:set offset".($conf)."P ".($expirepro_no11+$offset_remove)."}";}
   $scr_remno12=""; if($expirepro_no12!=0){$scr_remno12=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no12."\") do={:set offset".($conf)."P ".($expirepro_no12+$offset_remove)."}";}
   $scr_remno13=""; if($expirepro_no13!=0){$scr_remno13=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no13."\") do={:set offset".($conf)."P ".($expirepro_no13+$offset_remove)."}";}
   $scr_remno14=""; if($expirepro_no14!=0){$scr_remno14=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no14."\") do={:set offset".($conf)."P ".($expirepro_no14+$offset_remove)."}";}
   $scr_remno15=""; if($expirepro_no15!=0){$scr_remno15=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no15."\") do={:set offset".($conf)."P ".($expirepro_no15+$offset_remove)."}";}
   $scr_remno16=""; if($expirepro_no16!=0){$scr_remno16=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no16."\") do={:set offset".($conf)."P ".($expirepro_no16+$offset_remove)."}";}
   $scr_remno17=""; if($expirepro_no17!=0){$scr_remno17=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no17."\") do={:set offset".($conf)."P ".($expirepro_no17+$offset_remove)."}";}
   $scr_remno18=""; if($expirepro_no18!=0){$scr_remno18=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no18."\") do={:set offset".($conf)."P ".($expirepro_no18+$offset_remove)."}";}
   $scr_remno19=""; if($expirepro_no19!=0){$scr_remno19=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no19."\") do={:set offset".($conf)."P ".($expirepro_no19+$offset_remove)."}";}
   $scr_remno20=""; if($expirepro_no20!=0){$scr_remno20=" else={:if (\"\$prof".($conf)."P\" = \"".$pro_no20."\") do={:set offset".($conf)."P ".($expirepro_no20+$offset_remove)."}";}
   ###########################/.ADD############
  ...
  $settotal_remove="".$scr_remno1."".$scr_remno2."".$scr_remno3."".$scr_remno4."".$scr_remno5."".$scr_remno6."".$scr_remno7."".$scr_remno8."".$scr_remno9."".$scr_remno10."".$scr_remno11."".$scr_remno12."".$scr_remno13."".$scr_remno14."".$scr_remno15."".$scr_remno16."".$scr_remno17."".$scr_remno18."".$scr_remno19."".$scr_remno20."".$end20."".$end19."".$end18."".$end17."".$end16."".$end15."".$end14."".$end13."".$end12."".$end11."".$end10."".$end9."".$end8."".$end7."".$end6."".$end5."".$end4."".$end3."".$end2."";
	...
	$expire_name="PPPOEstep1_Expire_User_".($num)."";
	$disable_name="PPPOEstep2_Disable_Expire_User_".($num)."";
	$remove_name="PPPOEstep3_Remove_User_Disabled_".($num)."";
	...
	$start_time_remove="05:15:15";
	if($_REQUEST['show_error']==1){
		$show_error_expire=" else={:local name".($num+1)."ERR [/ppp secret get \$i".($num+1)."i name];:set prof".($conf)."P [/ppp secret get \$i".($num+1)."i profile ];:log error \"ERROR PPPOE EXPIRE SCRIPT user :\$name".($num+1)."ERR profile \$prof".($conf)."P error by comment \$date\";}";

		//$show_error_disable=" else={:local name".($num+2)."ERR [/ppp secret get \$i".($num+2)."i name];:set prof".($conf)."P [/ppp secret get \$i".($num+2)."i profile ];:log error \"ERROR PPPOE DISABLE SCRIPT user :\$name".($num+2)."ERR profile \$prof".($conf)."P error by comment \$date\";}";

		$show_error_remove=" else={:local name".($num+3)."ERR [/ppp secret get \$i".($num+3)."i name];:set prof".($conf)."P [/ppp secret get \$i".($num+3)."i profile ];:log error \"ERROR PPPOE REMOVE  SCRIPT user :\$name".($num+3)."ERR profile \$prof".($conf)."P error by comment \$date\";}";}else{
		$show_error_expire="";
		$show_error_disable="";
		$show_error_remove="";}

	 $on_event_expire="{:global offset".($conf)."P;:global today;:global prof".($conf)."P;global yearTODAY;{:local date [ /system clock get date ];:local time [/system clock get time ];:local montharray ( \"jan\",\"feb\",\"mar\",\"apr\",\"may\",\"jun\",\"jul\",\"aug\",\"sep\",\"oct\",\"nov\",\"dec\" );:set yearTODAY [ :pick \$date 7 11 ];:local monthdays;:if ((\$yearTODAY % 4) = 0 ) do={:set monthdays ( 31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31 );} else={:set monthdays ( 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31 );};:local days [ :pick \$date 4 6 ];:local daysmonth [ :pick \$date 0 3 ];:local monthtxt [ :pick \$date 0 3 ];:local months ([ :find \$montharray \$monthtxt]);:local hours [:pick \$time 0 2];:local minutes [:pick \$time 3 5];:local seconds [:pick \$time 6 8];:local todaytime ((\$hours*3600) + (\$minutes*60) + (\$seconds));:for nodays from=0 to=[:tonum \$months] do={:set days ( \$days + [ :pick \$monthdays \$nodays ]);:set daysmonth ( [ :pick \$monthdays \$nodays ] );};:set days ((\$yearTODAY-2017) * 365  + \$days -\$daysmonth );:set today (( \$days * 86400 )+\$todaytime);};:foreach i".($num+1)."i in [ /ppp secret find where disabled=no(".$settotal_pro." )] do={:if ([ :find [ /ppp secret get \$i".($num+1)."i comment ] ] = 0 ) do={:local date [ /ppp secret get \$i".($num+1)."i comment ];:local montharray ( \"jan\",\"feb\",\"mar\",\"apr\",\"may\",\"jun\",\"jul\",\"aug\",\"sep\",\"oct\",\"nov\",\"dec\" );:local monthtxt [ :pick \$date 0 3 ];:local countcomment [ len \$date];:if (\$countcomment >=20) do={:set \$countcomment 1;} else={:set \$countcomment 0;};:local aaa ([ :find \$montharray \$monthtxt]);:if (\$aaa > -1) do={:set \$aaa 1;} else={:set \$aaa 0;};:local bbb [ :pick \$date 3 4 ];:local ccc [ :pick \$date 6 7 ];:local ddd (\"\",\"/\");:local eee ([ :find \$ddd \$bbb]);:local eee2 ([ :find \$ddd \$ccc]);:local fff [ :pick \$date 14 15 ];:local ggg [ :pick \$date 17 18 ];:local hhh (\"\",\":\");:local kkk ([ :find \$hhh \$fff]);:local kkk2 ([ :find \$hhh \$ggg]);:local check".($num+1)."P (\$countcomment + \$aaa + \$eee + \$eee2 + \$kkk + \$kkk2);:if ((\$check".($num+1)."P)=6) do={:local year [ :pick \$date 7 11 ];:local monthdays;:if ((\$year % 4) = 0 ) do={:set monthdays ( 31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31 );} else={:set monthdays ( 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31 );};:local days [ :pick \$date 4 6 ];:local daysmonth [ :pick \$date 0 3 ];:local hours [:pick \$date 12 14];:local minutes [:pick \$date 15 17];:local seconds [:pick \$date 18 20];:local months ( [ :find \$montharray \$monthtxt ] );:local starttime ((\$hours*3600) + (\$minutes*60) + (\$seconds));:for nodays from=0 to=[:tonum \$months] do={:set days ( \$days + [ :pick \$monthdays \$nodays ] );:set daysmonth ( [ :pick \$monthdays \$nodays ] );:set prof".($conf)."P [/ppp secret get \$i".($num+1)."i profile ];".$settotal_expire."};:set days ((\$year-2017) * 365  + \$days -\$daysmonth );:set days ( \$days * 86400 );:local conoffset ( \$offset".($conf)."P * 3600 );:local stoplogoff (\$days + \$conoffset+\$starttime);:local plus 0;:if (((\$year % 4)=0)&&((\$yearTODAY % 4)!=0) ) do={:set \$plus 86400;};:if (((\$year % 4)=0)&&((\$yearTODAY % 4)=0)) do={:if (\$year != \$yearTODAY) do={:set \$plus 86400;};};:if ( \$stoplogoff < (\$today+\$plus)) do={ :local name".($num+1)."EXP [/ppp secret get \$i".($num+1)."i name];:log warning \"PPPOE EXPIRE SCRIPT: Profile \$prof".($conf)."P Set expire user :\$name".($num+1)."EXP  first logged in \$date\";[ /ppp secret disable \$i".($num+1)."i ];[ /ppp active remove [find where name=\$name".($num+1)."EXP] ];}}".$show_error_expire."}}}";

   $on_event_remove="{:global offset".($conf)."P;:global today;:global prof".($conf)."P;global yearTODAY;{:local date [ /system clock get date ];:local time [/system clock get time ];:local montharray ( \"jan\",\"feb\",\"mar\",\"apr\",\"may\",\"jun\",\"jul\",\"aug\",\"sep\",\"oct\",\"nov\",\"dec\" );:set yearTODAY [ :pick \$date 7 11 ];:local monthdays;:if ((\$yearTODAY % 4) = 0 ) do={:set monthdays ( 31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31 );} else={:set monthdays ( 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31 );};:local days [ :pick \$date 4 6 ];:local daysmonth [ :pick \$date 0 3 ];:local monthtxt [ :pick \$date 0 3 ];:local months ([ :find \$montharray \$monthtxt]);:local hours [:pick \$time 0 2];:local minutes [:pick \$time 3 5];:local seconds [:pick \$time 6 8];:local todaytime ((\$hours*3600) + (\$minutes*60) + (\$seconds));:for nodays from=0 to=[:tonum \$months] do={:set days ( \$days + [ :pick \$monthdays \$nodays ]);:set daysmonth ( [ :pick \$monthdays \$nodays ] );};:set days ((\$yearTODAY-2017) * 365  + \$days -\$daysmonth );:set today (( \$days * 86400 )+\$todaytime);};:foreach i".($num+3)."i in [ /ppp secret find where disabled=yes(".$settotal_pro." )] do={:if ([ :find [ /ppp secret get \$i".($num+3)."i comment ] ] = 0 ) do={:local date [ /ppp secret get \$i".($num+3)."i comment ];:local montharray ( \"jan\",\"feb\",\"mar\",\"apr\",\"may\",\"jun\",\"jul\",\"aug\",\"sep\",\"oct\",\"nov\",\"dec\" );:local monthtxt [ :pick \$date 0 3 ];:local countcomment [ len \$date];:if (\$countcomment >=20) do={:set \$countcomment 1;} else={:set \$countcomment 0;};:local aaa ([ :find \$montharray \$monthtxt]);:if (\$aaa > -1) do={:set \$aaa 1;} else={:set \$aaa 0;};:local bbb [ :pick \$date 3 4 ];:local ccc [ :pick \$date 6 7 ];:local ddd (\"\",\"/\");:local eee ([ :find \$ddd \$bbb]);:local eee2 ([ :find \$ddd \$ccc]);:local fff [ :pick \$date 14 15 ];:local ggg [ :pick \$date 17 18 ];:local hhh (\"\",\":\");:local kkk ([ :find \$hhh \$fff]);:local kkk2 ([ :find \$hhh \$ggg]);:local check".($num+3)."P (\$countcomment + \$aaa + \$eee + \$eee2 + \$kkk + \$kkk2);:if ((\$check".($num+3)."P)=6) do={:local year [ :pick \$date 7 11 ];:local monthdays;:if ((\$year % 4) = 0 ) do={:set monthdays ( 31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31 );} else={:set monthdays ( 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31 );};:local days [ :pick \$date 4 6 ];:local daysmonth [ :pick \$date 0 3 ];:local hours [:pick \$date 12 14];:local minutes [:pick \$date 15 17];:local seconds [:pick \$date 18 20];:local months ( [ :find \$montharray \$monthtxt ] );:local starttime ((\$hours*3600) + (\$minutes*60) + (\$seconds));:for nodays from=0 to=[:tonum \$months] do={:set days ( \$days + [ :pick \$monthdays \$nodays ] );:set daysmonth ( [ :pick \$monthdays \$nodays ] );:set prof".($conf)."P [/ppp secret get \$i".($num+3)."i profile ];".$settotal_remove."};:set days ((\$year-2017) * 365  + \$days -\$daysmonth );:set days ( \$days * 86400 );:local conoffset ( \$offset".($conf)."P * 3600 );:local stoplogoff (\$days + \$conoffset+\$starttime);:local plus 0;:if (((\$year % 4)=0)&&((\$yearTODAY % 4)!=0) ) do={:set \$plus 86400;};:if (((\$year % 4)=0)&&((\$yearTODAY % 4)=0)) do={:if (\$year != \$yearTODAY) do={:set \$plus 86400;};};:if ( \$stoplogoff < (\$today+\$plus)) do={ :local name".($num+3)."REM [/ppp secret get \$i".($num+3)."i name];:log warning \"PPPOE REMOVE SCRIPT:remove Profile \$prof".($conf)."P user \$name".($num+3)."REM first logged in \$date\";[ /ppp secret remove \$i".($num+3)."i ];}}".$show_error_remove."}}}";
   ...
   $API->comm("/system/scheduler/add", array(
		...
		$db->update_db("pppoe_pro",array("pro_expire"=>$expirepro_no1),"pro_name='".$pro_no1."'");
	$db->update_db("pppoe_pro",array("pro_expire"=>$expirepro_no2),"pro_name='".$pro_no2."'");
	$db->update_db("pppoe_pro",array("pro_expire"=>$expirepro_no3),"pro_name='".$pro_no3."'");
	$db->update_db("pppoe_pro",array("pro_expire"=>$expirepro_no4),"pro_name='".$pro_no4."'");
	$db->update_db("pppoe_pro",array("pro_expire"=>$expirepro_no5),"pro_name='".$pro_no5."'");
	$db->update_db("pppoe_pro",array("pro_expire"=>$expirepro_no6),"pro_name='".$pro_no6."'");
	$db->update_db("pppoe_pro",array("pro_expire"=>$expirepro_no7),"pro_name='".$pro_no7."'");
	$db->update_db("pppoe_pro",array("pro_expire"=>$expirepro_no8),"pro_name='".$pro_no8."'");
	$db->update_db("pppoe_pro",array("pro_expire"=>$expirepro_no9),"pro_name='".$pro_no9."'");
	$db->update_db("pppoe_pro",array("pro_expire"=>$expirepro_no10),"pro_name='".$pro_no10."'");
	$db->update_db("pppoe_pro",array("pro_expire"=>$expirepro_no11),"pro_name='".$pro_no11."'");
	$db->update_db("pppoe_pro",array("pro_expire"=>$expirepro_no12),"pro_name='".$pro_no12."'");
	$db->update_db("pppoe_pro",array("pro_expire"=>$expirepro_no13),"pro_name='".$pro_no13."'");
	$db->update_db("pppoe_pro",array("pro_expire"=>$expirepro_no14),"pro_name='".$pro_no14."'");
	$db->update_db("pppoe_pro",array("pro_expire"=>$expirepro_no15),"pro_name='".$pro_no15."'");
	$db->update_db("pppoe_pro",array("pro_expire"=>$expirepro_no16),"pro_name='".$pro_no16."'");
	$db->update_db("pppoe_pro",array("pro_expire"=>$expirepro_no17),"pro_name='".$pro_no17."'");
	$db->update_db("pppoe_pro",array("pro_expire"=>$expirepro_no18),"pro_name='".$pro_no18."'");
	$db->update_db("pppoe_pro",array("pro_expire"=>$expirepro_no19),"pro_name='".$pro_no19."'");
	$db->update_db("pppoe_pro",array("pro_expire"=>$expirepro_no20),"pro_name='".$pro_no20."'");
		




			echo "<script language='javascript'>swal('Save Done!','เพิ่ม Script 1.".$expire_name." และ  2.".$remove_name." สำเร็จแล้ว','success').then(function () {
