<?php
	...
	$num=$db->rows_num("SELECT pro_name FROM pppoe_pro where pro_name='".$_REQUEST['pro_name']."'");
            ...
            <div class="<?php print $convert->panel_modify();?>">
                <div class="<?php print $panel_heading;?>" >
                 ...
                 <div class="panel-body">
					...
					$result=$db->selectquery("SELECT * FROM pppoe_pro WHERE pro_name='".$_GET['name']."'");
					$rows=$db->rows_num("SELECT * FROM pppoe_pro WHERE pro_name='".$_GET['name']."'");
		            if($rows >0){
					?>
						<div class="col-xs-12 col-md-6">
                                <div class="form-group">
                     ...
                     <?php }else{?>     
						<div class="col-xs-12 col-md-6">
                                <div class="form-group">
                                    <span class=" style1">Price <img src="../img/help.png" width="16" height="16"  class="no1" data-toggle="tooltip" data-placement="right" title="กำหนดราคา ของ profile"></span>
                                    <option name="price" type="text" placeholder="กำหนดราคา ของ profile Exe.25,50,100" class="form-control" value="<?php echo $result['pro_price']; ?>">Empty profile on database...</option>
                               </div>
							</div>
					<?php }?>
