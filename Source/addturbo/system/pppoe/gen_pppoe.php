...
<section class="content"> 
           ...
           <i class="fa fa-user"></i>&nbsp;&nbsp;<strong> PPPOE Generate User</strong>
                    <?php print $date_time_show;?></div>                    
                
                <div class="panel-body">
                    <form name="login" action="index.php?page=con_genuser_pppoe_process" method="post">
					 <div class="row">
          ...
          <div  class="panel content" style="font-size: 12pt; line-height: 2em;">
            <p><h1 class="style2">&nbsp;&nbsp;&nbsp;ข้อแนะนำการใช้งาน :</h1>
               <ul>
                   <li>เลือก Package </li>
                   <li>Pattern Charactors เลือกรูปแบบของตัวอักษร และตัวเลข </li>
