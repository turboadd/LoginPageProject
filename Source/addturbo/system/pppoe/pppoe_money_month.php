...
"><a href="index.php?page=pppoe_total_money" class="btn btn-default fa fa-arrow-left"></a>&nbsp;<a href="index.php?page=pppoe_money_month" class="btn btn-default fa fa-rotate-right"></a> </span><br><br>
                        ...
                        <table class="table table-striped table-hover"  id="dataTables-example">
                                  <thead>
                                    ...
                                    <?php
													$id=$_SESSION['id'];
									$sql=$db->DB->prepare("SELECT * FROM pppoe_money WHERE mt_id='".$id."' GROUP BY month_code ");
	                                   $sql->execute();
									  	   $no=0;$total=0;
                                   while($result = $sql->fetch( PDO::FETCH_ASSOC ))	{
													...
													echo "<tr>";
															...
															echo "<td>";
												$count= $db->num_rows("pppoe_money","month_code","month_code='".$result['month_code']."'");
															echo $count;
															echo "</td>";
															echo "<td>";
                    ...
                    <div id="maximize" class="allsize" style="display:block;" >
						...
						<button  id="sizenormal2">1:1</button></div>
							<div class="chart">
							<div class="row">
            <div id="pppoe_money" style="height: 500px;"></div>
			</div>
<div id="sliders">
    <table>
        <tr>
