...
<section class="content">
		...
		<div class="col-lg-12">
			<div class="<?php print $convert->panel_modify();?>">
				<div class="<?php print $panel_heading;?>">
					...
					<strong><i class="fa fa-folder-open"></i>&nbsp;&nbsp;Hotspot Add Profile</strong>
					<?php print $date_time_show;?>
				</div>
				<div class="panel-body">
					<form name="login" action="index.php?page=con_addprofile_process" method="post">
						<div class="row">
							<div class="<?php if($_SESSION['money_cus'] == 0) { echo " col-md-12 "; } else {echo "col-xs-12 col-md-6 "; }?>">
						...
						<div class="row">
							...
							<div class="col-xs-12 col-md-6">
								<div class="form-group">
									<label for="cardExpiry"><span class=" style1">Idle Timeout</span> <img src="../img/help.png" width="16" height="16"  class="no1" data-toggle="tooltip" data-placement="right" title="กำหนดเวลา logout user ออกจากระบบถ้าไม่ได้ใช้งาน"></label>
						...
						<div class="row">
							<div class="col-xs-12 col-md-6">
								<div class="form-group">
									...
									<input name="keep" type="text" placeholder="Ex.00:15:00" class="form-control" value="00:15:00">
								</div>
							</div>
							<div class="col-xs-12 col-md-6">
								<div class="form-group">
						...
						<div class="row">
							<div class="col-lg-7 col-md-9 ">
								<div class="form-group">
									...
									<button id="btnSave" class="btn btn-danger" type="reset">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-refresh"></i>&nbsp;Reset&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>&nbsp;&nbsp;&nbsp;<span class="hidden-xs"><button type="button" class="btn btn-info" data-toggle="collapse" data-target="#manual"><span class="style2">ข้อแนะนำการใช้งาน </span>
									</button>
									</span>
								</div>
							</div>
	...
	<div id="manual" class="collapse">
		<div class="panel content" style="font-size: 12pt; line-height: 2em;">
			<p>
				<h1 class="style2">&nbsp;&nbsp;&nbsp;ข้อแนะนำการใช้งาน :</h1>
				<ul>
